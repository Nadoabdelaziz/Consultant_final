...
foreach ($services as $service) {
  if($service->slug == 'PhaiConsultant' ){
      $my_service = $service; 
  }
}
                        ...
                        <div id="scrollbar" class="art-scroll-frame">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-4" style="float: right;">
                                            ...
                                            <div class="art-a art-blog-card">
                                                <!-- post cover -->
                                                <a target="__blank"
                                                    href="{{ (isset($my_service->video)) ? url($my_service->video) : ''}}"
                                                    class="art-port-cover">
                                                    <!-- img -->
                                                    <img src="{{(isset($my_service->vid_cover)) ? asset('storage/app/public/'. $my_service->vid_cover) : ''}}"
                                                        alt="blog post">
                                                </a>
                                                <!-- post cover end -->
                                                <!-- post description -->
                            ...
                            <div class="container-fluid">
                                <div class="row p-30-0">
                                    ...
                                    <!-- col -->
                                    @include('partials.Phai.post', array('info'=>$last_phai_added))
                                    <!-- col end -->
                                    @else
                                    <!-- col -->
