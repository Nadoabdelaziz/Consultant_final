...
foreach ($services as $service) {
  if($service->slug == 'StrongConsultant' ){
      $my_service = $service; 
  }
}
?>
                        ...
                        <div id="scrollbar" class="art-scroll-frame">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row p-30-0">
                                    ...
                                    @if(isset($last_Strong_added))
                                    <!-- col -->
                                    @include('partials.Strong.post', array('info'=>$last_Strong_added))
                                    <!-- col end -->
                                    @else
                                    <!-- col -->
                                    @include('partials.Strong.post')
                                    <!-- col end -->
                                    @endif
