...
<?php
  ...
  foreach ($services as $service) {
    if($service->header == 'Product Name Consultant'){
      $price = $service->price;
    }
  }
?>
                      ...
                      <div class="frame-content" style="display: contents;">
                        ...
                        <div class="frame-content" style="background-color: #252532;border-radius: 20px;">
                          <div class="row art-form-field" style="/* padding-bottom:10px; *//* padding: 5px; *//* border-radius: 20px; *//* margin: 10px; */display: unset;/* float: right; background-color: #606060;*/"><br>
                            ...
                            <label for="frame3" onclick="mfunction()" style="color:black; width: max-content;margin-top: 16px;/* padding-top: 20px; *//* margin-bottom: 20px; *//* display: revert; */padding: 20px;font-weight: 800;font-size: x-large;background-color: #FFC107;border-radius: 12px;">{{__('Go To Show Price')}}</label>
                          </div>
