...
<?php
  ...
  foreach ($services as $service) {
    if($service->header == 'NewBorn Names Consultant'){
      $price = $service->price;
    }
  }
...
<div id="frame" style="">
          ...
          <hr style="background-color: white;margin-bottom: -27px;width: 70%;height: 4px;">
            <div class="row" style="height: 150px;width: min-content;display: inline-flex;">
              ...
              <div class="row" style="/* float: left; */height: 150px;width: min-content;display: inline-flex;">
              <label style="pointer-events: none;" id="frame_3"
                      for="frame3">2</label><br>
                  <h4 style="flex: auto;">{{__('Show Price')}}</h4>
              </div>

              <div class="row" style="/* float: left; */height: 150px;width: min-content;display: inline-flex;">
              <label style="pointer-events: none;" id="frame_4" style="padding-top: 6px;height: 65px;background-color: blue;width: 70px;"
                    for="frame4">1</label>
                        <br>
                ...
                <div class="inner">
                    <div class="frame frame_1">
                      <div class="frame-content" style="flex: none;">
                          <br><br>                            
                          <form action="Bornupload" method="POST" enctype="multipart/form-data" style="background-color: transparent">
                            @csrf
                      ...
                      <div class="frame-content">
                        ...
                        <div style="/* float: right; */background-color: #252532;width: 74%;border-radius: 20px;/* margin: 20px; */    display: inline-block;;">
                          ...
                          <div style="background-color: transparent;width: fit-content;display: contents;">  
                            <label for="frame1" onclick="mfunction3()" class="" style="border-radius: 20px;font-weight: 900;background-color:#FFC107;color:black;/* height: 31px; *//* width: 220px; */font-size: initial;margin: 20px;padding: 15px;">{{__('Go to Execution')}}</label>
                          </div>
                    ...
                    <div class="frame-content" style="{{isset($info) ? '/*background-color: dimgrey;*/border-radius: 20px;width: max-content;display: inline-block;' : ''}}">
                          ...
                          <div style="/* float: right; */background-color: #252532;border-radius: 20px;display: inline-flex;">
                                ...
                                <div class="row" style="/* padding-bottom:10px; */padding: 35px;/* border-radius: 20px; */margin: 10px;/* display: flow-root; background-color: #606060;*/">
                                  <div id="price" style="/* border-radius: 6px; *//* width: -webkit-fill-available; */font-size: xxx-large;font-weight: 900;/* text-align: center; */margin: 5px;">{{isset($price) ? $price : '10'}}$</div>
                                </div>
                                <!-- User ID : <input type = "text" name = "user_id" /> -->
                                <br>
                    ...
                    <div class="frame frame_4">
                      <div class="frame-content" style="display: contents;">
                          ...
                          @if(!isset($info))
                            ...
                            <form action="NewBornCons" method="post" enctype="multipart/form-data" style="background-color: transparent">
                              @csrf
                              <div class="art-form-field"
                                      ...
                                      <div style="margin: 10px; overflow-y: 20px;padding: 10px;border-radius: 20px;">
                                          ...
                                          <div id="pluss" class="row"
                                              ...
                                              <h2>
                                                  <div onclick="addtext()" style="color : #FFC107;cursor: pointer;">+</div>
                                              </h2>
                                          </div>
                              ...
                              <div class="art-form-field" style="float:left;height: fit-content;background-color: #2E2E39; border-radius:20px">
                                      ...
                                      {{__('NewBorn Names Consultant')}}</h3>
                                      <br><br>
                                    <div class="art-form-field" style="margin: 10px;padding: 10px;border-radius: 20px;">      
                                      ...
                                      <div class="row" style="/* padding-bottom:10px; *//* border-radius: 20px; */margin: 10px;display: flow-root;">
                                        <input type="text" style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;" name="father" placeholder="{{isset($info) ? $info->creator_name : __('father name')}}">
                                      </div>

                                      <br>

                                      <div class="row" style="/* padding-bottom:10px; *//* border-radius: 20px; */margin: 10px;display: flow-root;">
                                        <input type="text" style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;" name="grand" placeholder="{{isset($info) ? $info->activity : __('grandfather name')}}">
                                      </div>
                                      
                                      <br>

                                      <div class="row" style="/* padding-bottom:10px; *//* border-radius: 20px; */margin: 10px;display: flow-root;">
                                        <input type="text" style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;" name="nickname" placeholder="{{isset($info) ? $info->country :__('the nickname')}}">
                                      </div>


                                      <div class="row" style="/* padding-bottom:10px; *//* border-radius: 20px; */margin: 10px;display: flow-root;">
                                            <select name="pronunce" style="background-color: #23232d;border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;">
                                              <option value="none" style="color:white;" selected> {{__('Name pronunciation')}}</option>
                                              <option value="father" style="color:white;">{{__('newborn name with father')}}</option>
                                              <option value="father&grandfather" style="color:white;">{{__('newborn name with father and grandfather')}}</option>
                                              <option value="father&nickname" style="color:white;">{{__('newborn name with father and nickname')}}</option>
                                              <option value="grandfather" style="color:white;">{{__('newborn name with grandfather')}}</option>
                                              <option value="nickname" style="color:white;">{{__('newborn name with nickname')}}</option>
                                            </select>
                                      </div>
                                    </div>  
                              ...
                              <div class="art-form-field" style="padding: 14px;/* float:left; *//* height: fit-content; */background-color: #2E2E39; border-radius:20px;display: inline-block;margin: 120px;">
                                    ...
                                    <textarea name="Comment" id="" cols="20" rows="20" style="/* padding: 10px; margin-bottom: 42px;height: 200px;border-radius: 20px*/ width: 550px;margin: 11px;;" placeholder="{{isset($info) ? $info->comment : __('enter name here') }}"></textarea>
                                    <!-- User ID : <input type = "text" name = "user_id" /> -->
                                    <br>
                          ...
                          <div class="frame-content" style="background-color: #252532;border-radius: 20px;">
                            <div class="row art-form-field" style="/* padding-bottom:10px; *//* padding: 5px; *//* border-radius: 20px; *//* margin: 10px; */display: unset;/* float: right; background-color: #606060;*/"><br>
                              ...
                              style="color:black; width: max-content;margin-top: 16px;/* padding-top: 20px; *//* margin-bottom: 20px; *//* display: revert; */padding: 20px;font-weight: 800;font-size: x-large;background-color: #FFC107;border-radius: 12px;">{{__('Go To Show Price')}}</label>
                            </div>
