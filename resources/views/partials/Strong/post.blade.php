...
<?php
  ...
  foreach ($services as $service) {
    if($service->header == 'Strong Consultant'){
      $price = $service->price;
    }
  }
?>
                ...
                <div class="inner">
                    <div class="frame frame_1">
                      <div class="frame-content" style="flex: none;">
                          <br><br>                            
                          <form action="Strongupload" method="POST" enctype="multipart/form-data" style="background-color: transparent">
                            @csrf
                    ...
                    <div class="frame-content" style="display: contents;">
                        ...
                        @if(!isset($info))
                          ...
                          <form action="StrongCons" method="post" enctype="multipart/form-data" style="background-color: transparent">
                            @csrf
