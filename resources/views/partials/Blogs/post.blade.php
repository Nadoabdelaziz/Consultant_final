<?php
  ...
  foreach ($services as $service) {
    if($service->header == 'Places Consultant'){
      $price = $service->price;
    }
  }
?>
...
">
            ...
            <div class="row" style="/* float: left; */height: 150px;width: min-content;display: inline-flex;">
                <label id="frame_2" for="frame2">3</label><br>
                <h4 style="flex: auto;">{{__('Payment')}}</h4>
            </div>


            <div class="row" style="/* float: left; */height: 150px;width: min-content;display: inline-flex;">
                <label id="frame_3" for="frame3">2</label><br>
            ...
            <div class="row" style="/* float: left; */height: 150px;width: min-content;display: inline-flex;">
                <label id="frame_4" style="padding-top: 6px;height: 65px;background-color: blue;width: 70px;"
                    for="frame4">1</label>
                <br>
                <h4 style="flex: auto;">{{__('Fill Model')}}</h4>
            </div>
                ...
                <div class="inner">
                    <div class="frame frame_1">
                        <div class="frame-content" style="flex: none;">
                            ...
                            <form action="upload" method="POST" enctype="multipart/form-data"
                                ...
                                @csrf
                                <div class="row"
                                    style="/* float: right; */display: inline-table;background-color: #252532;border-radius: 20px;">
                                    <h2
                                        style="margin: 25px; /*background-color: crimson;*/ padding: 10px; border-radius: 20px; font-size: x-large;">
                                        {{__('invoice payment upload')}}
                                    </h2>
                                ...
                                ">
                                        ...
                                        <input
                                            style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                            type="hidden" name="id" value="{{isset($info) ? $info->id : '' }}"
                                            class="form-control">

                                    </div>
                                    <div class="col-md-6"
                                        style="background-color: transparent;width: fit-content;display: contents;">
                                        <button class="" type="submit"
                                            style="height: 45px;width: 220px;font-size: x-large;margin: 20px;background-color:#FFC107;">{{__('Execution')}}</button>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="frame frame_2">
                        <div class="frame-content">
                            <br><br>
                            <div
                                style="/* float: right; */background-color: #252532;width: 74%;border-radius: 20px;/* margin: 20px; */display: inline-block;">
                                ...
                                <div style="background-color: transparent;width: fit-content;display: contents;">
                                    ...
                                    style="border-radius: 20px;font-weight: 900;background-color:#FFC107;color:black;/* height: 31px; *//* width: 220px; */font-size: initial;margin: 20px;padding: 15px;">{{__('Go to Execution')}}</label>
                                </div>
                    ...
                    <div class="frame frame_3">
                        <div class="frame-content"
                            style="{{isset($info) ? '/*background-color: dimgrey;*/border-radius: 20px;width: max-content;display: inline-block;' : ''}}">
                            <br><br>

                            <div
                                style="/* float: right; */background-color: #252532;border-radius: 20px;display: inline-flex;">
                                <h3
                                    style="padding: 20px;/*background-color: #404040; width: 100%; */border-radius: 20px;display: inline-flex;/* margin-bottom: 20px; */margin: 10px">
                                    {{__('Total Price')}}</h3>
                                <br>
                                <div class="row"
                                    style="/* padding-bottom:10px; */padding: 35px;/* border-radius: 20px; */margin: 10px;/* display: flow-root; background-color: #606060;*/">
                                    <div
                                        style="/* border-radius: 6px; *//* width: -webkit-fill-available; */font-size: xxx-large;font-weight: 900;/* text-align: center; */margin: 5px;">
                                        {{isset($price) ? $price : '10'}}$</div>
                    ...
                    <div class="frame frame_4">
                        <div class="frame-content" style="display: contents;">
                            ...
                            <form action="PlacesCons" method="post" enctype="multipart/form-data"
                                style="background-color: transparent">
                                @csrf
                                <div class="art-form-field"
                                    style="margin-left: 47px; float: right;background-color: #2E2E39;border-radius: 20px;">
                                    <h2
                                        style="padding: 20px ; /*background-color: #252532; width: 100%; *//* margin-bottom: 20px; */margin: 10px;">
                                        {{__('List Of Names')}}</h2>
                                    <input type="text" name="user"
                                        value="{{(auth()->user()) ? auth()->user()->email : ''}}" style="display:none">
                                    ...
                                    <div style="margin: 10px; overflow-y: 20px;padding: 10px;border-radius: 20px;">
                                        ...
                                        <div id="text-0" class="row"
                                            ...
                                            <input
                                                style="border-radius: 6px;width:86%;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                                type="text" placeholder="{{__('enter name here')}}" name="Sec">

                                            <div id="subtract" class="row"
                                                style="/* padding-bottom:10px; padding: 5px; border-radius: 20px; */margin: 10px;/* display: flow-root; */float: right;">
                                                <h2>
                                        ...
                                        <div id="text-6" class="row"
                                            ...
                                            <div id="subtract" class="row"
                                                style="/* padding-bottom:10px; padding: 5px; border-radius: 20px; */margin: 10px;/* display: flow-root; */float: right;">
                                                <h2>
                                                    <label onclick="subtext(6)" style="color : #FFC107">-</label>
                                                </h2>
                                            </div>
                                        </div>
                                        ...
                                        @for($i=8 ; $i < 90; $i++) <div id="text-{{$i}}" class="row"
                                            style="/* padding-bottom:10px; padding: 5px; border-radius: 20px; */margin: 10px;display: none;">
                                            <input
                                                style="border-radius: 6px;width:86%;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                            ...
                                            <div id="subtract" class="row"
                                                style="/* padding-bottom:10px; padding: 5px; border-radius: 20px; */margin: 10px;/* display: flow-root; */float: right;">
                                                <h2>
                                                    <label onclick="subtext($i)" style="color : #FFC107">-</label>
                                                </h2>
                                            </div>
                                    </div>
                                    @endfor
                        ...
                        <!-- **************************************************************************** -->
                        <div class="art-form-field"
                            style="float:left;height: fit-content;background-color: #2E2E39; border-radius:20px">
                            <h3
                                style="padding: 20px;/* width: 100%; border-radius: 20px;display: inline-flex;*/ /*  margin-bottom: 20px; */margin: 7px;">
                                {{__('Places Consultant')}}</h3>
                            <br><br>
                            <div class="art-form-field" style="margin: 10px;padding: 10px;border-radius: 20px;">

                                <div class="row"
                                    style="/* padding-bottom:10px; *//* border-radius: 20px; */margin: 10px;display: flow-root;">
                                    <input type="text"
                                        style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                        name="inventor"
                                        placeholder="{{isset($info) ? $info->creator_name : __('Inventor Name')}}">
                                </div>

                                @for ($i = 1; $i < 101 ; $i++) <div class="row"
                                    style="/* padding-bottom:10px; *//* border-radius: 20px; */margin: 10px;display: none;"
                                    id="invent-{{$i}}">
                                    <input type="text"
                                        style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                        name="inventor{{$i}}"
                            ...
                            <div id="invent" id="pluss" class="row"
                                style="/* padding-bottom:10px; padding: 5px; border-radius: 20px; */margin: -8px;display: flow-root;/* background-color: whitesmoke; */">
                                <h5 style="background-color: #23232d;display: -webkit-inline-box;padding: 7px;margin: 16px;"
                                    class="row">
                                    <label
                                        style=" pointer-events: none;color: #FFC107;/* height: fit-content; *//* width: 88%; */margin: 18px;"
                                        placeholder="">{{__('press here to add partner name')}}</label>
                                    <label onclick="addinventor()"
                                        style="color: #FFC107;/* height: fit-content; *//* width: 88%; */background-color: #2E2E39;/* margin: 18px; */padding: 5px;font-size: x-large;"
                                        placeholder="">+</label>
                                </h5>
                            </div>
                            <br>
                            ...
                            <div class="row"
                                ...
                                <input type="text"
                                    style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                    name="activity"
                                    placeholder="{{isset($info) ? $info->activity : __('Enter Activity')}}">
                            </div>
                            ...
                            <div class="row"
                                ...
                                <input type="text"
                                    style="border-radius: 6px;width: -webkit-fill-available;font-size: 17px;font-weight: 900;text-align: center;margin: 5px;"
                                    name="country" placeholder="{{isset($info) ? $info->country :__('enter country')}}">
                            </div>
                    ...
                    <div class="art-form-field"
                        style="padding: 14px;/* float:left; *//* height: fit-content; */background-color: #2E2E39; border-radius:20px;display: inline-block;margin: 120px;">
                        <h2
                            style="padding: 10px;/* width: 100%; border-radius: 20px;*//* display: inline-flex; *//* margin-bottom: 20px; */margin: -2px;">
                            {{__('Comment')}}</h2>
                        <textarea name="Comment" id="" cols="20" rows="20"
                            style="/* padding: 10px; margin-bottom: 42px;height: 200px;border-radius: 20px*/ width: 550px;margin: 11px;;">{{isset($info) ? $info->comment : __('enter name here') }}</textarea>
                        <!-- User ID : <input type = "text" name = "user_id" /> -->
                        <br>
                    ...
                    <div class="alert alert-warning"
                        style="margin: 30px;font-size: larger;text-align: end;padding: 25px;width: -webkit-fill-available;">
                        <p style="margin: 8px;font-weight: bold;font-size: initial;padding-bottom: 15px;">
                            {{__('Please Pay Attention')}} : </p> <br>
                        <br>
                    ...
                    <div style="background-color: transparent;width: fit-content;display: contents;">
                        ...
                        <button class=""
                            style="background-color:#FFC107; height: 45px;width: 220px;font-size: x-large;margin: 20px;"
                            type="submit">{{__('Book a consultation')}}</button>
                    ...
                    <div class="frame-content" style="background-color: #252532;border-radius: 20px;">
                        <div class="row art-form-field"
                            style="/* padding-bottom:10px; *//* padding: 5px; *//* border-radius: 20px; *//* margin: 10px; */display: unset;/* float: right; background-color: #606060;*/">
                            <br>
                            <h2
                                style="padding: 20px;/* width: 100%; */border-radius: 20px;/* display: inline-flex; *//* margin-bottom: 20px; */margin: 10px;">
                                {{__('Registration Done Successfully')}}
                            </h2>
                            <label onclick="mfunction()" for="frame3"
                                style="color:black; width: max-content;margin-top: 16px;/* padding-top: 20px; *//* margin-bottom: 20px; *//* display: revert; */padding: 20px;font-weight: 800;font-size: x-large;background-color: #FFC107;border-radius: 12px;">
                                {{__('Go To Show Price')}}</label>
                        </div>
