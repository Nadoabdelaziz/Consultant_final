...
<?php
  ...
  foreach ($services as $service) {
    if($service->header == 'Other Consultants'){
      $price = $service->price;
    }
  }
                ...
                <div class="inner">
                    <div class="frame frame_1">
                      <div class="frame-content" style="flex: none;">
                          <br><br>                            
                          <form action="otherupload" method="POST" enctype="multipart/form-data" style="background-color: transparent">
                            @csrf
                    ...
                    <div class="frame-content" style="{{isset($info) ? '/*background-color: dimgrey;*/border-radius: 20px;width: max-content;display: inline-block;' : ''}}">
                          ...
                          <div style="/* float: right; */background-color: #252532;border-radius: 20px;display: inline-flex;">
                                ...
                                <div style="/* border-radius: 6px; *//* width: -webkit-fill-available; */font-size: xxx-large;font-weight: 900;/* text-align: center; */margin: 5px;">{{isset($price) ? $price : '10'}}$</div>
                                </div>
                                <!-- User ID : <input type = "text" name = "user_id" /> -->
                                <br>
                    ...
                    <div class="frame-content" style="display: contents;">
                        ...
                        @if(!isset($info))
                          ...
                          <form action="othercons" method="post" enctype="multipart/form-data" style="background-color: transparent">
                            @csrf
                          ...
                          <div class="frame-content" style="background-color: #252532;border-radius: 20px;">
                            <div class="row art-form-field" style="/* padding-bottom:10px; *//* padding: 5px; *//* border-radius: 20px; *//* margin: 10px; */display: unset;/* float: right; background-color: #606060;*/"><br>
                              ...
                              <label onclick="mfunction()" for="frame3"
                                        style="color:black; width: max-content;margin-top: 16px;/* padding-top: 20px; *//* margin-bottom: 20px; *//* display: revert; */padding: 20px;font-weight: 800;font-size: x-large;background-color: #FFC107;border-radius: 12px;">{{__('Go To Show Price')}}
                                        </label>
                            </div>
