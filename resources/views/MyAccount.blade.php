                ...
                ?>
                              ...
                              text-align: -webkit-right;">
                                                        ...
                                                        <ul style="width: 100%;">
                                                            ...
                                                            <li style="margin-bottom: 25px;">
                                                                <form
                                                                    action="{{ url(app()->getLocale().'/edit-email/','email') }}"
                                                                ...
                                                                <h5 style="font-weight: bolder;">
                                                                    {{isset($C_User->name) ? __($C_User->email) : '' }}
                                                                </h5>
                                                            ...
                                                            <li style="margin-bottom: 25px;">
                                                                ...
                                                                <h5 style="font-weight: bolder;">
                                                                    {{isset($C_User->mobile_number) ? __($C_User->mobile_number) : '' }}
                                                                </h5>
                                                            ...
                                                            <!-- age -->
                                                            <li style="margin-bottom: 25px;">
                                                                <h5 style="color: white;"><a href="#">{{__('Edit')}}</a>
                                                                </h5>
                                                                <h5 style="font-weight: bolder;">
                                                                    {{isset($C_User->residence) ? __($C_User->residence) : '' }}
                                                                </h5>
                                                            ...
                                                            <li style="margin-bottom: 25px;">
                                                                ...
                                                                <h5 style="font-weight: bolder;">
                                                                    {{isset($C_User->city) ? __($C_User->city) : '' }}
                                                                </h5>
                                                            ...
                                                            <li style="margin-bottom: 25px;">
                                                                ...
                                                                <h5 style="font-weight: bolder;">{{__($membership)}}
                                                                </h5>
                                                            ...
                                                            <!-- age -->
                                                            <li style="margin-bottom: 25px;">
                                                                <h6 style="width: 5%;color:yellow"><i class="fa fa-pen"
                                                                        aria-hidden="true" style="color: gold;"></i>
                                                                </h6>
                                                                <h5><i class="fa fa-check" aria-hidden="true"
                                                                        style="color: greenyellow;"></i></h5>
